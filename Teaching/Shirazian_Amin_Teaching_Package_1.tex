...
\begin{document}
	...
	CECN 204 Introductory Macroeconomics Distance Winter 2027 - Unit 2 (Job ID = 395938)
	...
	I am writing to apply for the position of {CECN 204 Introductory Macroeconomics Distance Winter 2027 - Unit 2 (395938)}. I am completing my PhD in Economics at Toronto Metropolitan University (expected August 2026), and over the past two years I have taught six university course sections as instructor of record while serving as a teaching assistant in thirteen graduate and undergraduate courses. I believe my record demonstrates exactly the combination your posting asks for: current disciplinary knowledge, proven effectiveness with adult and diverse learners, and strong online teaching capability.
	
	My knowledge is current because I am an active researcher. My dissertation builds a quantitative model of household saving under health risk, estimated on recent U.S. survey data, and my lectures draw directly on this research practice: when I teach intermediate macroeconomics, students see the post-pandemic inflation episode and recent central bank policy analyzed with the same tools they are learning, not stylized examples frozen in a textbook edition.
	
	My lecturing experience is largely with adult learners. My CECN courses run through TMU's Chang School of Continuing Education, whose students are predominantly working adults returning to study part-time. Teaching this population has shaped my practice: I anchor theory in students' own professional and financial experience, design flexible assessment around work schedules, and treat questions from practice as teaching assets rather than digressions. TMU's downtown Toronto classrooms are also among the most diverse in the country --- first-generation, international, and racialized students form the majority in my sections --- and my research on market access in remote Indigenous communities reflects a genuine commitment to economic questions affecting underserved populations.
	
	These same Chang School courses are delivered online, so my online teaching is tested at scale: live Zoom lectures, course management on D2L Brightspace, online assessment design, and active discussion boards. Across my TA and lecturer roles I have handled thousands of student inquiries by email, and my Graduate Assistant Recognition Awards (2022, 2023) reflect that responsiveness.   
